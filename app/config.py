...
class Settings(BaseSettings):
    ...
    def get_masked_dict(self) -> dict:
        ...
        return {
            ...
            "MAILJET_FROM_NAME": self.MAILJET_FROM_NAME,
            "SMTP_HOST": self.SMTP_HOST or "",
            "SMTP_PORT": self.SMTP_PORT,
            "SMTP_USER": mask(self.SMTP_USER or ""),
            "SMTP_PASSWORD": mask(self.SMTP_PASSWORD or ""),
    ...
    def save_to_env_file(self, env_path: str = ".env"):
        ...
        lines = [
            ...
            "",
            f"AUTH_EMAIL={self.AUTH_EMAIL}",
            f"MAILJET_API_KEY={self.MAILJET_API_KEY or ''}",
            f"MAILJET_SECRET_KEY={self.MAILJET_SECRET_KEY or ''}",
            f"MAILJET_FROM_EMAIL={self.MAILJET_FROM_EMAIL}",
            f"MAILJET_FROM_NAME={self.MAILJET_FROM_NAME}",
            f"SMTP_HOST={self.SMTP_HOST or ''}",
            f"SMTP_PORT={self.SMTP_PORT}",
            f"SMTP_USER={self.SMTP_USER or ''}",
